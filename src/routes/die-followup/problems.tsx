  ...
  return (
    <div className="w-full px-4 py-6 sm:px-6 sm:py-8">
      ...
      <p className="mt-2 text-muted-foreground">
        ...
        Photographs can be attached. Open and solved problems stay in the
        history below; which dies and which faults keep coming back is on the{' '}
        <Link to="/die-followup/reports" className="underline hover:no-underline">
          Reports
        </Link>{' '}
        page. The operation and problem type lists are managed by the admin.
      </p>
